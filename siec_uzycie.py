...
oko2 = cv2.imread("obrazki/images/06_g.jpg", cv2.IMREAD_GRAYSCALE)
maska2 = cv2.imread("obrazki/manual1/06_g.tif", cv2.IMREAD_GRAYSCALE)
...
p2.imshow(maska_otrz, cmap="gray")
p2.title.set_text("Wynik")
p3.imshow(maska2, cmap="gray")
p3.title.set_text("Wzór")
plt.show()
